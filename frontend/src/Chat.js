    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .msg-row { display: flex; gap: 8px; max-width: 68%; position: relative; }
        .msg-row.mine { align-self: flex-end; flex-direction: row-reverse; animation: slideInRight 0.25s ease-out; }
